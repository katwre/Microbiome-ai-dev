...
out <- filterAndTrim("sampleID_1.trimmed_1.trim.fastq.gz", "sampleID_1_1.filt.fastq.gz", "sampleID_1.trimmed_2.trim.fastq.gz", "sampleID_1_2.filt.fastq.gz",
    truncLen = c(230, 229),
...
if(out[2] == '0'){
    for(fp in c("sampleID_1_1.filt.fastq.gz", "sampleID_1_2.filt.fastq.gz")){
...
write.table( out, file = "sampleID_1.filter_stats.tsv", sep = "\t", row.names = FALSE, quote = FALSE, na = '')
