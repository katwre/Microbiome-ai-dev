...
qiime taxa collapse \
    ...
    --p-level 2 \
    --o-collapsed-table "lvl2-badpairwise10.qza"

# Extract summarised table and output a file with the number of taxa
qiime tools export \
    --input-path "lvl2-badpairwise10.qza" \
    --output-path exported/
biom convert \
    -i exported/feature-table.biom \
    -o "lvl2-badpairwise10.feature-table.tsv" \
    --to-tsv

if [ $(grep -v '^#' -c "lvl2-badpairwise10.feature-table.tsv") -lt 2 ]; then
    mkdir differentials
    ...
    qiime composition ancombc \
        --i-table "lvl2-badpairwise10.qza" \
        --m-metadata-file "Metadata.tsv" \
        --p-prv-cut 0.1 --p-lib-cut 500 --p-alpha 0.05 --p-conserve \
        --p-formula 'badpairwise10' \
        --o-differentials "lvl2-badpairwise10.differentials.qza" \
        --verbose
    qiime tools export \
        --input-path "lvl2-badpairwise10.differentials.qza" \
        --output-path "differentials/Category-badpairwise10-level-2"

    # Generate tabular view of ANCOM-BC output
    qiime composition tabulate \
        --i-data "lvl2-badpairwise10.differentials.qza" \
        --o-visualization "lvl2-badpairwise10.differentials.qzv"
    qiime tools export \
        --input-path "lvl2-badpairwise10.differentials.qzv" \
        --output-path "differentials/Category-badpairwise10-level-2"
    ...
    qiime composition da-barplot \
        ...
        --o-visualization "lvl2-badpairwise10.da_barplot.qzv"
    qiime tools export --input-path "lvl2-badpairwise10.da_barplot.qzv" \
        --output-path "da_barplot/Category-badpairwise10-level-2"
fi
